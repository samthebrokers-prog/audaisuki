...
export const regions: Region[] = [
  ...
  },
  {
    ...
    introEn: "Gold Coast information for Japanese residents and the wider community, covering work, housing, food, services and events.",
    consularName: "Consulate-General of Japan in Brisbane",
    consularArea: "Queensland",
    consularUrl: "https://www.brisbane.au.emb-japan.go.jp/",
    localBusinesses: [
  ...
  },
  {
    ...
    state: "TAS",
    city: "Tasmania",
    introJa: "タスマニア在住の日本人向けに、生活、地域サービス、イベント、領事情報をまとめた地域ページです。",
    introEn: "Tasmania information for Japanese residents, local services, community events and consular guidance.",
    consularName: "Consulate-General of Japan in Melbourne",
    consularArea: "Victoria, Tasmania & South Australia",
    consularUrl: "https://www.melbourne.au.emb-japan.go.jp/",
    localBusinesses: [],
